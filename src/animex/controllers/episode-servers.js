import { getAnimexEpisodeServers } from '../scraper/episode-servers.js';
...
export const animexEpisodeServersController = async (c) => {
  try {
    ...
    const cacheKey = ['animex', 'episode-servers', animeEpisodeId, ep || ''].join(':');
    ...
    const data = await getAnimexEpisodeServers({ animeEpisodeId, ep });
